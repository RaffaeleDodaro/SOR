...
# questo programma deve essere avviato prima del client
# in modo tale da avere il socket listener gia' in ascolto

serverPort = 6789  # creo listening socket
welcomeSocket = socket()
welcomeSocket.bind(('',
                    serverPort))  # '' significa "mettiti in ascolto su tutte le interfacce che hai". bind significa attacca la spina al socket stesso
welcomeSocket.listen(
    5)  # mettimi in listen. 5 rappresenta il numero di telefonate che posso bufferizzare. al massimo voglio 5 buffer
